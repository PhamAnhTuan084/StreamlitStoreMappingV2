...
def round3_motfile(HVN_r3):
    ...
    location90storename100 = result_df.loc[(result_df['Score_Distance'] >= 90) & (result_df['Score_Name'] == 100)]
...
def apply_filter_motfile(row):
    ward_name = row['WardName_1']
    district_name = row['DistrictName_1']
    province_name = row['ProvinceName_1']
    distance = row['distance']
...
def round4_motfile(HVN_r4):
    ...
    if merged_df.empty:
        ...
        filtered_result = merged_df[merged_df.apply(apply_filter_motfile, axis=1)]
...
def Loc_motfile(df):
    # Tính toán 'Score_Address'
    df['Score_Address'] = df.apply(calc_score_address_motfile, axis=1)
    ...
    # Groupby theo 'OutletID_1'
    grouped_outlet1 = df.groupby('OutletID_1')
    ...
    for outlet_id, group in grouped_outlet1:
        ...
        # Kiểm tra xem 'OutletID_2' đã xét trước đó chưa và không trùng với final_result
...
def apply_round1_motfile(HVN, teleco1, teleco2):
    ...
    phonenum_map = round1_motfile(HVN_thoa)
    ...
    if st.button("Apply"):        
        if rounds:
            ...
            if HVN is not None and Vigo is not None:
                st.subheader("***Mapping On Two Files***")      
            ...
            elif HVN is not None and Vigo is None:
                st.subheader("***Mapping On One File***")
                st.text("Conditions are being considered!")
                HVN = xet_latlng(HVN)
                ...
                if rounds == [1]:
                    st.text("Current round is [1]")
                    phonenum_map , HVN_thoa, HVN_khongthoa = apply_round1_motfile(HVN, teleco1, teleco2)
                    st.subheader("Displaying file 1 after checking phone:")
                    st.dataframe(HVN_thoa)
                    ...
                    if phonenum_map.empty:
                        ...
                        # Loại bỏ data thỏa round1
                        HVN_r2 = HVN.loc[lambda df: ~df.OutletID.isin(phonenum_map.OutletID_1)]                      
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True) 
                        st.dataframe(HVN_r2)
                    ...
                    if matching_address.empty:
                        ...
                        HVN_r2 = HVN.loc[lambda df: ~df.OutletID.isin(matching_address.OutletID_1)]                       
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True) 
                        st.dataframe(HVN_r2)
                    ...
                    location90storename100 = round3_motfile(HVN_without_NoName)
                    st.markdown('<h3 style="display:flex; align-items:center;">&hybull; Displaying round 3:</h3>', unsafe_allow_html=True)
                    st.dataframe(location90storename100)
                    ...
                    if location90storename100.empty:   
                        ...
                        HVN_r4 = HVN.loc[lambda df: ~df.OutletID.isin(location90storename100.OutletID_1)]
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN_r4)
                    ...
                    if danh_sach_1.empty:                    
                        ...
                        HVN_r5 = HVN.loc[lambda df: ~df.OutletID.isin(danh_sach_1.OutletID_1)]
                        danh_sach_chua_chay = pd.concat([HVN_r5, HVN_with_NoName])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(danh_sach_chua_chay)
                    ...
                    if phonenum_map.empty and matching_address.empty:
                        ...
                        HVN_chuachay = HVN.loc[lambda df: ~df.OutletID.isin(phonenum_map.OutletID_1)]      
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                
                    ...
                    if phonenum_map.empty and danh_sach_1.empty:
                        ...
                        HVN_r5 = df3.loc[lambda df: ~df.OutletID.isin(danh_sach_1.OutletID_1)]
                        HVN_r5 = pd.concat([HVN_r5, HVN_with_NoName])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r5)
                    ...
                    st.text("Current round is [1]")
                    phonenum_map , HVN_thoa, HVN_khongthoa = apply_round1_motfile(HVN_r2, teleco1, teleco2)
                    st.subheader("Displaying file 1 after checking phone:")
                    st.dataframe(HVN_thoa)
                    st.markdown('<h3 style="display:flex; align-items:center;">&hybull; Displaying round 1:</h3>', unsafe_allow_html=True)
                    st.dataframe(phonenum_map)
                    ...
                    if matching_address.empty and phonenum_map.empty:
                        ...
                        HVN_chuachay = HVN.loc[lambda df: ~df.OutletID.isin(matching_address.OutletID_1)]                      
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_chuachay)      
                    else:         
                        matching_address['level'] = 2    
                    ...
                    if matching_address.empty and location90storename100.empty:
                        ...
                        HVN_r4 = HVN_without_NoName.loc[lambda df: ~df.OutletID.isin(location90storename100.OutletID_1)]
                        HVN_r4 = pd.concat([HVN_r4, HVN_with_NoName])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r4)
                    ...
                    if location90storename100.empty:
                        ...
                        HVN_r2 = HVN_without_NoName.loc[lambda df: ~df.OutletID.isin(location90storename100.OutletID_1)]
                        HVN_r2 = pd.concat([HVN_r2, HVN_with_NoName])
                    ...
                    if danh_sach_1.empty:
                        ...
                        HVN_r2 = df3.loc[lambda df: ~df.OutletID.isin(danh_sach_1.OutletID_1)]
                        HVN_r2 = pd.concat([HVN_r2, HVN_with_NoName])
                    ...
                    if danh_sach_1.empty and phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)
                    elif phonenum_map.empty:
                        danh_sach_1['level'] = 4
                        ...
                        danh_sach_1['level'] = 4
                        phonenum_map['level']= 1
                        ket_qua = pd.concat([danh_sach_1, phonenum_map])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; Summary:</h3>', unsafe_allow_html=True)
                        st.dataframe(ket_qua)                        
                    ...
                    if danh_sach_1.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                
                    elif  matching_address.empty:
                        danh_sach_1['level'] = 4
                        ...
                        danh_sach_1['level'] = 4
                        matching_address['level']= 2
                        ket_qua = pd.concat([danh_sach_1, matching_address])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; Summary:</h3>', unsafe_allow_html=True)
                        st.dataframe(ket_qua)                        
                    ...
                    if danh_sach_1.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                     
                    elif location90storename100.empty:
                        danh_sach_1['level'] = 4
                        ...
                        danh_sach_1['level'] = 4
                        location90storename100['level']= 3
                        ket_qua = pd.concat([danh_sach_1, location90storename100])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; Summary:</h3>', unsafe_allow_html=True)
                        st.dataframe(ket_qua)                        
                        
                        HVN_r3 = HVN_without_NoName.loc[lambda df: ~df.OutletID.isin(location90storename100.OutletID_1)] 
                        HVN_r3 = pd.concat([HVN_r3, HVN_with_NoName])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r3)
                    ...
                    if phonenum_map.empty and location90storename100.empty and matching_address.empty:
                        ...
                        HVN_r3 = HVN.loc[lambda df: ~df.OutletID.isin(ket_qua.OutletID_1)]
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r3)
                    ...
                    if phonenum_map.empty and location90storename100.empty and danh_sach_1.empty :                  
                        ...
                        HVN_r5 = HVN.loc[lambda df: ~df.OutletID.isin(ket_qua.OutletID_1)]
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r5)
                    ...
                    if danh_sach_1.empty:
                        ...
                        HVN_r3 = df3.loc[lambda df: ~df.OutletID.isin(danh_sach_1.OutletID_1)]
                        HVN_r3 = pd.concat([HVN_r3, HVN_with_NoName])
                    ...
                    if phonenum_map.empty and danh_sach_1.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif matching_address.empty:
                        phonenum_map['level'] = 1
                    ...
                    if phonenum_map.empty and danh_sach_1.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        phonenum_map['level'] = 1
                    ...
                    st.text("Current round is [1]")
                    phonenum_map, HVN_thoa, HVN_khongthoa = apply_round1_motfile(HVN_r3, teleco1, teleco2)
                    st.subheader("Displaying file 1 after checking phone:")
                    st.dataframe(HVN_thoa)
                    st.markdown('<h3 style="display:flex; align-items:center;">&hybull; Displaying round 1:</h3>', unsafe_allow_html=True)
                    st.dataframe(phonenum_map)
                    ...
                    if matching_address.empty and danh_sach_1.empty and  phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif phonenum_map.empty:
                        matching_address['level'] = 2
                    ...
                    if matching_address.empty and danh_sach_1.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        matching_address['level'] = 2
                    ...
                    if location90storename100.empty and danh_sach_1.empty and  phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif phonenum_map.empty:
                        location90storename100['level'] = 3
                    ...
                    if location90storename100.empty and danh_sach_1.empty and  matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif matching_address.empty:
                        location90storename100['level'] = 3
                        ...
                        HVN_r5 = df1.loc[lambda df: ~df.OutletID.isin(matching_address.OutletID_1)]
                        HVN_r5 = pd.concat([HVN_r5, HVN_r2_khonghtoa])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r5)
                    ...
                    if danh_sach_1.empty and  phonenum_map.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                     
                    elif matching_address.empty:
                        danh_sach_1['level'] = 4
                        ...
                        HVN_chuachay = df1.loc[lambda df: ~df.OutletID.isin(matching_address.OutletID_1)]
                        HVN_chuachay = pd.concat([HVN_chuachay, HVN_r2_khonghtoa])            
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                
                        st.dataframe(HVN_chuachay)
                    ...
                    if danh_sach_1.empty and phonenum_map.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        danh_sach_1['level'] = 4
                        ...
                        HVN_chuachay = HVN_without_NoName.loc[lambda df: ~df.OutletID.isin(location90storename100.OutletID_1)]
                        HVN_chuachay = pd.concat([HVN_chuachay, HVN_with_NoName])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_chuachay)
                    ...
                    if danh_sach_1.empty and  matching_address.empty and phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)   
                    elif phonenum_map.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and matching_address.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and  location90storename100.empty and phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif phonenum_map.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and  location90storename100.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                                               
                    elif matching_address.empty:
                        danh_sach_1['level'] = 4                       
                    ...
                    if danh_sach_1.empty:
                        ...
                        HVN_r4 = df3.loc[lambda df: ~df.OutletID.isin(danh_sach_1.OutletID_1)]
                        HVN_r4 = pd.concat([HVN_r4, HVN_with_NoName])
                    ...
                    if phonenum_map.empty and matching_address.empty and danh_sach_1.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        phonenum_map['level'] = 1
                        ...
                        HVN_r5 = HVN_r4.loc[lambda df: ~df.OutletID.isin(location90storename100.OutletID_1)]
                        HVN_r5 = pd.concat([HVN_r5, HVN_with_NoName])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r5)
                    ...
                    if phonenum_map.empty and location90storename100.empty and danh_sach_1.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif matching_address.empty:
                        phonenum_map['level'] = 1
                    ...
                    if phonenum_map.empty and danh_sach_1.empty and  matching_address.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        phonenum_map['level'] = 1
                    ...
                    if phonenum_map.empty and danh_sach_1.empty and location90storename100.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                                               
                    elif matching_address.empty:
                        phonenum_map['level'] = 1
                    ...
                    if matching_address.empty and phonenum_map.empty and danh_sach_1.empty and  location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        matching_address['level'] = 2
                        ...
                        HVN_r5 = HVN_without_NoName.loc[lambda df: ~df.OutletID.isin(location90storename100.OutletID_1)]
                        HVN_r5 = pd.concat([HVN_r5, HVN_with_NoName])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r5)
                    ...
                    st.text("Current round is [1]")
                    phonenum_map , HVN_thoa, HVN_khongthoa = apply_round1_motfile(HVN_r4, teleco1, teleco2)
                    st.subheader("Displaying file 1 after checking phone:")
                    st.dataframe(HVN_thoa)
                    st.markdown('<h3 style="display:flex; align-items:center;">&hybull; Displaying round 1:</h3>', unsafe_allow_html=True)
                    st.dataframe(phonenum_map) 

                    if matching_address.empty and location90storename100.empty and danh_sach_1.empty and  phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif phonenum_map.empty:
                        matching_address['level'] = 2
                        ...
                        HVN_r5 = HVN_thoa.loc[lambda df: ~df.OutletID.isin(phonenum_map.OutletID_1)]
                        HVN_r5 = pd.concat([HVN_r5, HVN_khongthoa])
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)                   
                        st.dataframe(HVN_r5)
                    ...
                    if matching_address.empty and danh_sach_1.empty and  phonenum_map.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        matching_address['level'] = 2
                    ...
                    if matching_address.empty and danh_sach_1.empty and location90storename100.empty and phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif phonenum_map.empty:
                        matching_address['level'] = 2
                    ...
                    if location90storename100.empty and phonenum_map.empty and danh_sach_1.empty and  matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif matching_address.empty:
                        location90storename100['level'] = 3
                    ...
                    if location90storename100.empty and matching_address.empty and danh_sach_1.empty and  phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif phonenum_map.empty:
                        location90storename100['level'] = 3
                    ...
                    if location90storename100.empty and danh_sach_1.empty and  phonenum_map.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                     
                    elif matching_address.empty:
                        location90storename100['level'] = 3
                    ...
                    if location90storename100.empty and danh_sach_1.empty and matching_address.empty and phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)   
                    elif phonenum_map.empty:
                        location90storename100['level'] = 3
                    ...
                    if danh_sach_1.empty and  phonenum_map.empty and matching_address.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and  phonenum_map.empty and location90storename100.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                                               
                    elif matching_address.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and  matching_address.empty and phonenum_map.empty and location90storename100.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif location90storename100.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and  matching_address.empty and location90storename100.empty and phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN) 
                    elif phonenum_map.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and  location90storename100.empty and phonenum_map.empty and matching_address.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)                     
                    elif matching_address.empty:
                        danh_sach_1['level'] = 4
                    ...
                    if danh_sach_1.empty and  location90storename100.empty and matching_address.empty and phonenum_map.empty:
                        st.markdown('<h3 style="display:flex; align-items:center;">&cir; List of unsatisfactory Outlets:</h3>', unsafe_allow_html=True)
                        st.dataframe(HVN)  
                    elif phonenum_map.empty:
                        danh_sach_1['level'] = 4                      
